...
const IlCurriculumVitae = () => {
  ...
  return (
    <PageShell title="Il curriculum vitae" subtitle="Una traccia per guardarsi dentro">
      <article className="space-y-6">
        <p className={pCls}>Il primo gesto concreto fu banale: ripresi in mano il mio curriculum vitae.</p>
        <p className={pCls}>Non per mandarlo da qualche parte — con la pensione appena arrivata, quell'idea mi sembrava quasi comica. Lo ripresi per aggiornarlo con la data di fine servizio e poi, per la prima volta, leggerlo dall'inizio alla fine come se fosse il documento di qualcun altro.</p>
        <p className={pCls}>Fu una lettura strana. C'erano quarant'anni di vita compressi in poche pagine. Date, ruoli, qualifiche, competenze. Tutto esatto, tutto verificabile, tutto — mi resi conto — rivolto verso l'esterno. Il curriculum vitae non racconta chi sei: racconta cosa hai fatto nell'ottica di chi potrebbe avere bisogno di te. È un documento di utilità, non di identità. È la risposta alla domanda degli altri, non alla tua.</p>
        <p className={pCls}>Mi era sempre pesato scriverlo, aggiornarlo, mandarlo. Quella sensazione di doversi ridurre a un elenco puntato, di scegliere cosa includere e cosa omettere sapendo che qualcuno avrebbe valutato, classificato, approvato o scartato. Ora capivo meglio perché: non era ansia da prestazione. Era il disagio di chi sa che quell'elenco non è davvero la persona che lo sta scrivendo, ma che in quel momento non ha un'alternativa da offrire.</p>
        <p className={pCls}>C'è un esperimento celebre nell'ambito della psicologia dell'educazione — l'Effetto Pigmalione — in cui un gruppo di insegnanti fu convinto che certi studenti avessero un potenziale eccezionale, scelti in realtà completamente a caso. Quegli studenti, trattati con maggiore fiducia e aspettativa, effettivamente migliorarono. La conclusione è semplice e un po' vertiginosa: il giudizio degli altri su di noi modifica il modo in cui ci comportiamo, e quindi quello che diventiamo. Le etichette non sono neutre. Plasmano.</p>

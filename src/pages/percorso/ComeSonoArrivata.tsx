  ...
  return (
    ...
    >
      <article className="space-y-6">
        ...
        <p className={pCls}>Questa sezione non ha racconti né finali da riscrivere. Ha tracce da seguire, o da ignorare, o da modificare secondo le proprie esigenze. Strumenti concreti che ho usato io, e che propongo non come ricetta ma come punto di partenza. Il curriculum vitae, la linea del tempo, l'albero genealogico, i luoghi, le parole che fanno stare bene: ciascuno è un modo diverso di guardarsi e di capire da dove si parte.</p>

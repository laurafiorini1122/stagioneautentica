...
const paragrafi = [
  ...
  "La donna aveva fatto quello che si fa. Lo aveva fatto senza considerarlo un sacrificio, perché era sua madre, era quello che si fa. Ma lo aveva fatto anche con quella competenza silenziosa che le donne sviluppano in questo campo e che nessuno chiama con il suo nome. Sapeva come parlare con i medici, sapeva quali domande fare, sapeva interpretare le risposte che non venivano date. Sapeva, soprattutto, come reggere tutto senza che sua madre si accorgesse del peso.",
  "Ora aveva sessantaquattro anni.",
  "Non era vecchia. Camminava bene, dormiva abbastanza, aveva energie per quello che voleva fare. Ma c'era un calcolo che aveva iniziato a fare, involontariamente, come un'applicazione che si avvia senza che tu l'abbia aperta. Guardava sua madre e sottraeva. Gli anni che le restavano, secondo quei numeri che aveva imparato a leggere. Il risultato era un numero che preferiva non guardare troppo a lungo.",
  "I suoi figli vivevano lontano, di chilometri non di affetto. Telefonavano. Si preoccupavano quando sentivano qualcosa di strano nella sua voce. Le chiedevano come stava con quella premura un po' vigile che lei riconosceva, perché era la stessa che usava lei con sua madre.",
  ...
  "Lo stesso faceva con sua madre. Quando i medici le dicevano cose che non erano rassicuranti, le filtrava, le addolciva, le rendeva meno pesanti. Proteggeva sua madre dalle parole difficili e proteggeva i suoi figli dalle sue preoccupazioni. Stava nel mezzo, a fare da schermo in entrambe le direzioni.",
  ...
  "C'era qualcosa che non riusciva a formulare con precisione, ma che sentiva con quella chiarezza sorda delle cose che si sanno e non si vogliono sapere: stava proteggendo sua madre dalla realtà per non dover fare la conversazione che quella realtà portava con sé. La conversazione in cui si dicono le cose che si rimanda a dire. Quella in cui ci si saluta, davvero, mentre c'è ancora tempo.",

  ...
  return (
    ...
    >
      ...
      <article className="space-y-6">
        ...
        <p className={pCls}>Scrivere mi ha aiutata a fare chiarezza, a superare certi nodi e, finalmente, ad apprezzare questa fase per quello che è davvero: nuova, libera, tutta da costruire.</p>
        ...
        <p className={pCls}>La nuova protagonista è una donna. Non per convenzione, ma perché le donne sanno trasformarsi senza perdere il filo di sé — e lo fanno da sempre, spesso in silenzio. I finali saranno sempre positivi e realistici — non favole, ma modi concreti di guardare la pensione con occhi diversi.</p>
        <p className={`${pCls} italic`}>
          Riscriviamo insieme — questa volta per abitare la stagione più autentica.
        </p>
        <p className={`${pCls} italic`}>
          E se dopo aver letto e scritto ti è venuta voglia di raccontare anche il tuo percorso — come sei arrivata fin qui, cosa hai trovato lungo la strada — la terza parte è proprio quello spazio.
        </p>
      </article>

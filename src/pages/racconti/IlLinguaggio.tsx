...
const paragrafi = [
  ...
  "Poi, il silenzio della pensione recise i contatti. L'uomo si ritrovò in una cucina silenziosa, circondato da oggetti che non avevano bisogno di definizioni tecniche. Provò a usare il suo linguaggio con la moglie, con i vicini, con il commesso del tabaccaio. Ma le parole, private del loro contesto, suonavano come frammenti di una lingua morta.",
  "Cercò di descrivere la sua giornata usando i vecchi parametri. Parlò di ottimizzazione dei tempi morti, di gestione delle risorse domestiche, di obiettivi trimestrali per la manutenzione della casa. Le parole gli morivano in gola. Applicare quel lessico alla scelta di un detersivo o alla durata di una passeggiata era come cercare di riparare un orologio da polso con una mazza ferrata.",
  "Il processo di erosione fu rapido. Iniziò a dimenticare i nomi tecnici che un tempo erano la sua identità. La sua mente stava diventando un magazzino di attrezzi arrugginiti.",
  "L'ultimo giorno di lucidità linguistica, l'uomo cercò di spiegare il suo malessere. Aprì la bocca, ma non uscì nulla che avesse un senso. Il mondo fuori era diventato un frastuono di voci che parlavano una lingua troppo veloce, troppo viva, troppo giovane. Lui era un ricevitore sintonizzato su una frequenza spenta.",
  "Si sedette al tavolo e smise di provare. La sua bocca rimase chiusa, la lingua pesante come un sasso. Non era solo il silenzio della casa ad avvolgerlo, era il silenzio del pensiero. Non c'era più nulla da dire, perché non c'era più nessuno che parlasse la sua lingua. La cancellazione era totale: era un libro scritto in un alfabeto che nessuno, nemmeno lui, sapeva più leggere.",
];

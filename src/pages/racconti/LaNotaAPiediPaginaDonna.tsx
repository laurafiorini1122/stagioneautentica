...
const paragrafi = [
  ...
  "Iniziò a frequentare i musei e le chiese per inventariare la durata dei nomi. Fissava le lapidi nelle navate, le firme in calce alle tele, i busti di marmo nei giardini pubblici. Quegli uomini avevano sconfitto il tempo con la pietra o il colore. Lei, invece, non aveva lasciato nulla che non fosse deperibile.",
  "La donna iniziò a cercare un modo per forzare la serratura della memoria collettiva. Analizzò freddamente la realtà: l'unica via d'accesso rapida all'eternità pubblica, per una persona qualunque, era l'infamia. Per un istante, accarezzò l'idea di un gesto eclatante, non per odio, ma per protocollo: un investimento deliberato sulla propria visibilità postuma. Ma la logica burocratica che l'aveva plasmata riprese il sopravvento. Anche il gesto estremo era soggetto a un rapido smaltimento. Una notizia di cronaca durava una settimana. L'infamia era volatile quanto la gloria.",
];

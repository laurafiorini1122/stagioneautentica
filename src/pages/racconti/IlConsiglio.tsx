...
const paragrafi = [
  ...
  "«Sai che Renato fa fotografia? Ha vinto anche un concorso online.»",
  "«Giorgio fa tai chi da due anni — dice che non ha più mal di schiena.»",
  "«Massimo gioca a padel tre volte a settimana. Ha perso cinque chili.»",
  "Nelle serate con gli amici, l'uomo brillava. Conosceva tutto di ogni attività senza averne praticata seriamente nessuna. Era diventato una specie di critico gastronomico che non mangia: valutava, comparava, consigliava a sua volta, con l'autorevolezza di chi ha fatto ricerca approfondita.",
  "Ma il momento che attendeva davvero, quello che giustificava tutto il resto, era un altro. Era quando, incontrando un ex collega al bar o al supermercato, poteva dire con nonchalance: «Sono molto preso dal mio corso di fotografia rurale». E mentre lo diceva, cercava negli occhi dell'altro la conferma — quella scintilla di rispetto che certificasse che il suo tempo, pur non essendo più fatturato, avesse ancora una dignità produttiva. Voleva che il mondo gli attribuisse un'equipollenza: tra il vecchio ruolo e il nuovo status di pensionato attivo, tra il bilancio trimestrale e il corso in presenza il martedì mattina. Ogni hobby era un tentativo di fabbricarsi un nuovo biglietto da visita, un'etichetta che gli permettesse di presentarsi — a sé stesso prima ancora che agli altri — senza dover affrontare il vuoto pneumatico che stava sotto.",
  ...
  "In questo perenne inseguimento dell'approvazione altrui, l'uomo evitava accuratamente l'unica analisi necessaria: quella dello specchio. La sua vita era diventata un collage di suggerimenti non filtrati, un'accozzaglia di interessi superficiali scelti da altri. Non si curava di capire cosa volesse lui; si curava di apparire conforme a un'idea di vecchiaia dinamica ed elegante. Di invecchiare nel modo giusto, quello che gli altri potevano riconoscere e approvare.",
  "La questione non era cosa fare. Era essere visto mentre lo si faceva.",
  "Così continuò a chiamare. Continuò ad ascoltare, ad annotare, a valutare. Gli amici, nel tempo, smisero di chiedergli a che punto fosse. Non per indifferenza, ma per una forma silenziosa di pietà — la stessa che si prova davanti a chi cerca le chiavi di casa sotto il lampione non perché le abbia perse lì, ma perché è l'unico posto illuminato.",
  "L'adattamento al nuovo status, alla fine, fallì per eccesso di messinscena. Invece di trasformarsi, l'uomo si era limitato a cambiare costume, restando inchiodato a una mentalità competitiva che esigeva un pubblico per esistere. Senza pubblico non c'era recita. Senza recita non c'era lui.",

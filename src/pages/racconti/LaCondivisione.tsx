...
const paragrafi = [
  ...
  "Le settimane successive, l'uomo partecipò con regolarità. Ascoltava, prendeva appunti, faceva domande. Quando vedeva qualcosa che poteva migliorare, un processo, una comunicazione, la gestione di un piccolo progetto, lo diceva, cercando di non pestare piedi che non conosceva ancora.",
  ...
  "Continuò ad andare alle riunioni per altre tre settimane, trascinato da qualcosa che non avrebbe saputo nominare. Poi smise, senza comunicarlo, senza scrivere a Ferruccio, senza spiegazioni.",
  ...
  "Non era una proposta per nessuno. Non aveva un ordine del giorno.",
  "Fuori, qualcuno stava distribuendo nelle cassette il bollettino del mese successivo. Probabilmente stampato male, come sempre.",
];

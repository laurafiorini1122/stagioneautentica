...
const paragrafi = [
  ...
  "Giorgia faceva yoga tutte le mattine, in casa, prima di colazione. «Impari ad ascoltarti», spiegò, con una calma che pareva esibita. «Dopo un po' non riesci più a immaginare di farne a meno.» La donna si iscrisse al corso per principianti. Comprò il tappetino, le calze antiscivolo, cercò su internet la differenza tra hatha e vinyasa e annotò la data della prima lezione sull'agenda con una grafia particolarmente curata, come se l'atto di scrivere fosse già metà del lavoro.",
  "Andò alla prima lezione. Poi alla seconda. Alla terza telefonò a Marta per raccontarle dello yoga, ma Marta la interruppe quasi subito: «Già, ma hai sentito parlare del padel?». In dieci minuti la donna aveva scoperto che il padel era «lo sport del momento», che «lo facevano tutti», che «non serviva essere atletiche» e che «il bello era la socialità». La donna annotò il numero dell'istruttrice.",
  "Non tornò più al corso di yoga. Disse a Giorgia che aveva avuto dei problemi alla schiena, il che era plausibile anche se non vero.",
  ...
  "«Sai che Renata fa fotografia? Ha vinto anche un concorso online.» «Giorgia fa yoga da due anni — dice che dorme meglio di quando aveva trent'anni.» «Marta gioca a padel tre volte a settimana. Ha perso cinque chili.»",
  "Nelle serate con le amiche, la donna brillava. Conosceva tutto di ogni attività senza averne praticata seriamente nessuna. Era diventata una specie di critica gastronomica che non mangia.",
  "Ma il momento che attendeva davvero, quello che giustificava tutto il resto, era un altro. Era quando, incontrando un'ex collega al bar o al supermercato, poteva dire con nonchalance: «Sono molto presa dal mio corso di fotografia rurale». E mentre lo diceva, cercava negli occhi dell'altra la conferma — quella scintilla di rispetto che certificasse che il suo tempo, pur non essendo più fatturato, avesse ancora una dignità produttiva. Voleva che il mondo le riconoscesse una parità: tra il vecchio ruolo e il nuovo status di pensionata attiva, tra il bilancio trimestrale e il corso in presenza il martedì mattina. Ogni hobby era un tentativo di fabbricarsi un nuovo biglietto da visita, un'etichetta che le permettesse di presentarsi — a sé stessa prima ancora che agli altri — senza dover affrontare il vuoto pneumatico che stava sotto.",
